...
// Button setup
void buttons_setup(uint8_t pin_b1, uint8_t pin_b2, uint8_t pin_b3, uint8_t pin_b4, uint8_t pin_enc)
{
...
void buttons_update(void)
{
    ...
    if (bt4ActiveState_s != bt4Active_s)
    {
        ...
        if (bt4Active_s)  
        {
            keyboard_press_button(BTN_4, BTM_PRESS);
        }
        else
        {
            keyboard_press_button(BTN_4, BTM_RELEASE);
        }
    }
